...
/*
   ...
   To implement calibration in your project sketch the simplified procedure is as follow:
       ...
       Press t to tare, c to set manual parameter.
*/
...
// pins:
byte HX711_dout = FORCE_RIGHT_DOUT_PIN;
byte HX711_sck = FORCE_RIGHT_SCK_PIN;
...
void setup() {
  ...
  /*
  // not in use because i found no solution to make chooseLoadcell() work yet --> Loadcells have to be constructed with pin numbers in global already
